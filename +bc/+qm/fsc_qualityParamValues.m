...
% 
% ------
% FSC notes: modified the following values based on EAJ's
% qualityParamValues.m. Caveat: this was last updated in 2023 so not sure
% if some values need to be modified again
% Modified:
% param.maxRPVviolations = 1 (default 0.1)
% param.maxWvBaselineFraction = 1 (default 0.3)
% param.maxPercSpikesMissing = 20 (default 10)
% param.minSNR = 2 (default 1)
% param.maxWvDuration = 10000; (default 1150)
% param.minSpatialDecaySlope = -10; % in a.u./um (fsc; default -0.008) ??
...
param.maxWvDuration = 10000; % in us (fsc; default 1150)
param.minSpatialDecaySlope = -10; % in a.u./um (fsc; default -0.008)
...
param.maxRPVviolations = 1; % fraction (fsc; default = 0.1)
